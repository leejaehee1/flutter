...
class _OnTapScreennState extends State<OnTapScreen>
  ...
  void initState() {
    ...
    draft.punch_issue_Category = [login.draftList[Get.arguments]['category']];
    draft.punch_issue_System = [login.draftList[Get.arguments]['systemID']];
    draft.punch_issue_Sub_System = [
      login.draftList[Get.arguments]['subsystem']
    ];
    ...
    draft.punch_issue_Action_On = [
      login.draftList[Get.arguments]['department']
    ];
    draft.punch_issue_Discipline = [
      login.draftList[Get.arguments]['discipline']
    ];
    draft.punch_issue_Raised_On = [login.draftList[Get.arguments]['raisedBy']];
